...
class CloudflareScraper(Session):
    ...
    def solve_cf_challenge(self, resp, **original_kwargs):
        ...
        #params["jschl_answer"] =cache.get(self.solve_challenge(body, domain), 3, False, table='cookies')
    ...
    @classmethod
    def get_content(cls, url,timeout=40, user_agent=None, **kwargs):
        scraper = cls.create_scraper()
        logging.warning('get tokem2')
        if user_agent:
            scraper.headers = user_agent
        ...
        try:
            ...
            logging.warning(e)
            logging.warning("'%s' returned an error. Could not collect tokens." % url)
            raise
    ...
    @classmethod
    def get_tokens(cls, url,timeout=40, user_agent=None, **kwargs):
        scraper = cls.create_scraper()
        logging.warning('get tokem')
        if user_agent:
            scraper.headers = user_agent
...
get_content=CloudflareScraper.get_content
